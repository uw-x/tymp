...
#if defined(BOARD_PCA10040)
extern uint32_t CAM_SPI_PIN_MASK = 1UL << 20;//This parameter and the next line should be changed together and should have the same value
extern uint32_t CAM_SPI_CS =  20;//This parameter and the previous line should be changed together and should have the same value
//extern uint32_t CAM_LINE_VLD =  14;
extern uint32_t CAM_POWER =  23;
