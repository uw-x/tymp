...
//    disable: image 160*320 //In test pattern mode, enabling this does not have any effect
    ...
    hm_i2c_write(0x1003,0x00);//default from lattice 0x08
    hm_i2c_write(0x1007,0x00);//default from lattice 0x08
...
//    hm_i2c_write(0x1012,0x00);
    ...
    hm_i2c_write(0x2101,0x80);//lattice 0x80
    hm_i2c_write(0x2102,0x10);//lattice 0x40
...
//    hm_i2c_write(0x0104,0x00);//makes the image look crooked!
    ...
    hm_i2c_write(0x020E,0x00);//Vikram
    hm_i2c_write(0x020F,0x00);//Vikram
    hm_i2c_write(0x0202,0x00);//Vikram
    hm_i2c_write(0x0203,0x02);//Vikram
    /*looking at lattice cfg setting*/
