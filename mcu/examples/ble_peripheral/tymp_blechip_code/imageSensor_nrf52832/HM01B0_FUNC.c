...
//    hm_i2c_write( REG_MODE_SELECT, 0x01);//go to stand by mode
...
//    hm_i2c_write(REG_FRAME_LENGTH_LINES_H,CAM_MOTOR_REG_FRAME_LENGTH_LINES_H);
//    hm_i2c_write(REG_FRAME_LENGTH_LINES_L,CAM_MOTOR_REG_FRAME_LENGTH_LINES_L);
...
//    hm_i2c_write(0x1012,0x07);//changed by Ali
    ...
    hm_i2c_write(0x2101,0xB0);//0x70);//lattice 0xA0
