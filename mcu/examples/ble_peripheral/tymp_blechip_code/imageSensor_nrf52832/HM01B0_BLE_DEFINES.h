...
#define CAM_MOTOR_REG_FRAME_LENGTH_LINES_H 0x07
#define CAM_MOTOR_REG_FRAME_LENGTH_LINES_L 0x12

#define PWM_STEPS_NUM 1//2//200
...
#define HM_CLK 11 //23//11  /**< Pin number for output. */
#endif 
...
#define LEFT 0
#define RIGHT 1
#define LEFT_EN  17//29//17
#define RIGHT_EN 7//30//7
#define MOTOR_TIMER_VALUE_LEFT  10000
#define MOTOR_TIMER_VALUE_RIGHT 10000
#define MOTOR_CAMERA_TIMER 20000
#define BLE_LED_ON 0
...
Timer 3 => pwm 3  NRF_DRV_TIMER_INSTANCE(3) ===> Nov 18: Shared between the motor driver and mechanical arm
