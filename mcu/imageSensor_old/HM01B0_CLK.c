...
/** @file
 * @defgroup HM01B0_CLK.c
 * @{
 * @ingroup imageSensor
 * @brief Setting the clock for the HM01B0 image sensor. We use timer clock for that
 *
...
//
//
///*outputs mcu clock to the image sensor*/
///*clock is set to 8MHz*/
...
//
//
//    nrf_drv_timer_extended_compare(&timer, (nrf_timer_cc_channel_t)0, 1UL, NRF_TIMER_SHORT_COMPARE0_CLEAR_MASK, false);
//
...
//    printf("error_code: %x \n", err_code);
    ...
    uint32_t timer0_prescaler = 0x00000000;
    (*timer0_prescaler_address) = timer0_prescaler;
